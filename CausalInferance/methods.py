...
class Causality:
    ...
    def mle_approach(
        ...
        **kwargs 
        ...
        l_x_y = -np.log(np.var(residuals_X)) - np.log(np.var(X))
        
        print((-np.log(np.var(residuals_X)), - np.log(np.var(X))))
        ...
        l_y_x = -np.log(np.var(residuals_y)) - np.log(np.var(y))
        
        print((-np.log(np.var(residuals_y)), - np.log(np.var(y))))
